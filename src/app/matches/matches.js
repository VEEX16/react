    ...
    return (
      <div>
        <div className="page-header">
          <h3 className="page-title"> Matches </h3>
        ...
        <div className="row">
                  ...
                  <table className="table table-hover">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><label className="badge badge-danger">28 <i class="mdi mdi-arrow-down"></i></label></td>
                      </tr>
                      <tr>
                        <td>Messsy</td>
                        <td>Flash</td>
                      ...
                      <tr>
                        ...
                        <td><label className="badge badge-info"> 0  - </label></td>
                      </tr>
                      <tr>
                        <td>Peter</td>
                        <td>After effects</td>
                        <td className="text-success"> 82.00% <i className="mdi mdi-arrow-up"></i></td>
                        <td><label className="badge badge-success">82 <i className="mdi mdi-arrow-up"></i></label></td>
                      </tr>
                      <tr>
                        <td>Dave</td>
                        <td>53275535</td>
          ...
          <div className="col-lg-12 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Najbliższe spotkanie</h4>
                <div className="row justify-content-md-center title">
                  <p>23.09.2020 godz: 20:00</p>
                </div>
                <div className="row justify-content-md-center">
                  <div className="col col-lg-auto">
                    <div class="logo">
                      <img src={require("../../assets/images/teams/1.png")} alt="" />
                    </div>
                  </div>
                ...
                <div className="row justify-content-md-center players">
                  <div className="col col-lg-3">
                    <div className="left">
                      <p>Imię "nick" nazwisko</p>
                      <p>Imię "nick" nazwisko</p>
                      <p>Imię "nick" nazwisko</p>
                      <p>Imię "nick" nazwisko</p>
                      <p>Imię "nick" nazwisko</p>
                ...
                <div className="row justify-content-md-center live">
                  <div className="col col-lg-2">
                    <button type="button" class="btn btn-danger btn-lg btn-block">Oglądaj na żywo</button>
                  </div>
                </div>
              </div>
            </div>
