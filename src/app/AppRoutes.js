...
const PlayOff = lazy(() => import('./groups/PlayOff'));

const Team = lazy(() => import('./team-page/Team'));
const AddTeam = lazy(() => import('./team-page/AddTeam'));
const EditTeam = lazy(() => import('./team-page/EditTeam'));
...
const Browsersource = lazy(() => import('./browsersource-pages/Browsersource'));
    ...
    return (
      <Suspense fallback={<Spinner />}>
        <Switch>
          ...
          <Route path="/playoff" component={PlayOff} />
          <Route path="/matches" component={Matches} />

          <Route path="/team/team" component={Team} />
          <Route path="/team/addteam" component={AddTeam} />
          <Route path="/team/editteam" component={EditTeam} />
          ...
          <Route path="/bs" component={Browsersource} />
