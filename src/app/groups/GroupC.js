      ...
      <ReactCardFlip isFlipped={this.state.isFlipped} flipDirection="vertical">
        ...
        <div className="card">
          <div className="card-body">
            <h4 className="card-title">Grupa C</h4>
        ...
        <div className="card">
          <div className="card-body round-name">
            <h4 className="card-title">Grupa C</h4><button type="button" onClick={this.handleClick} class="btn btn-outline-danger">Widok tabeli</button>
