                ...
                <div className="clearfix">
                  ...
                  <div className="float-right">
                    ...
                    <div className="fluid-container">
                      <h3 className="font-weight-medium text-right mb-0 text-light">$65,650</h3>
                    </div>
                  </div>
                </div>
              ...
              <div className="card-body">
                ...
                <div className="fluid-container">
                  <div className="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                    ...
                    <div className="ticket-details col-md-9">
                      <div className="d-lg-flex">
                        <p className="text-light font-weight-semibold mr-2 mb-0 no-wrap">James :</p>
                  ...
                  <div className="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                    ...
                    <div className="ticket-details col-md-9">
                      <div className="d-lg-flex">
                        <p className="text-light font-weight-semibold mr-2 mb-0 no-wrap">Stella :</p>
                  ...
                  <div className="row ticket-card mt-3">
                    ...
                    <div className="ticket-details col-md-9">
                      <div className="d-lg-flex">
                        <p className="text-light font-weight-semibold mr-2 mb-0 no-wrap">John Doe :</p>
